...
if (qtdRodas ==2 and qtdRodas ==3 and qtdPessoas >=1 and qtdPessoas <=3  and peso <3500):
    print()
...
#Categoria E --> (Veículos com quatro rodas ou mais e com mais de 6000 kg).
    ...
    print()  
    print("================== Atenção ======================================================================================")
    print(" Esse carro não se enquadra em nenhuma das Categorias de CNH, verifique os dados informados abaixo e tente novamente.")
    print(f" Comporta {qtdPessoas} pessoas, possui {qtdRodas} rodas e seu peso é de {peso}!")
